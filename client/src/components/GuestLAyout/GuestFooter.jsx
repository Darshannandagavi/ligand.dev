      ...
      <div style={styles.footerContainer}>
        ...
        <div style={styles.footerTop}>
          ...
          <div style={styles.footerSection}>
            <h3 style={styles.sectionTitle}>About ligand Software Solutions</h3>
            <p style={styles.sectionText}>
              Ligand Software Solution is a leading technology company offering
              innovative software solutions and IT services across various
          ...
          <div style={styles.footerSection}>
            ...
            <ul style={styles.contactList}>
              <li style={styles.contactItem}>
                ...
                <span>ligand Software Solutions,Sankeshwar 591313</span>
              </li>
              <li style={styles.contactItem}>
                <svg
                  width="20"
                ...
                <span>info@ligandsoftwaresolution.in</span>
              </li>
              <li style={styles.contactItem}>
                <svg
                  width="20"
        ...
        <div style={styles.footerBottom}>
          <p style={styles.copyrightText}>
            &copy; {new Date().getFullYear()} Ligand Software Solutions. All
            Rights Reserved.
          </p>
          <div style={styles.legalLinks}>
            ...
            <span style={styles.legalSeparator}>|</span>
            <a
              href="https://www.google.com/maps?q=16.257645350164296, 74.49145840620825"
              target="_blank"
...
const addFooterHoverEffects = () => {
  ...
  if (newsletterButton) {
    const hoverElement = newsletterButton.querySelector(
      ".newsletterButtonHover"
    );
