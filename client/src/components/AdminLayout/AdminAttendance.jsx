...
const AdminAttendance = () => {
  ...
  const fetchStudents = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await axios.get(
        "https://ligand-software-solutions-workshop-2.onrender.com/api/attendance/students",
        {
      ...
      try {
        const attRes = await axios.get("https://ligand-software-solutions-workshop-2.onrender.com/api/attendance", {
  ...
  const fetchAttendanceForPeriod = async (type = "weekly") => {
    ...
    try {
      ...
      const token = localStorage.getItem("token");
      const res = await axios.get("https://ligand-software-solutions-workshop-2.onrender.com/api/attendance", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://ligand-software-solutions-workshop-2.onrender.com/api/attendance",
        payload,
        {
          headers: { Authorization: token ? `Bearer ${token}` : "" },
        }
