...
//     try {
//       const res = await axios.get("https://ligand-software-solutions-workshop-2.onrender.com/api/notes/active"); 
...
//     try {
//       if (editingId) {
//         await axios.put(`https://ligand-software-solutions-workshop-2.onrender.com/api/notes/${editingId}`, form);
//       } else {
//         await axios.post("https://ligand-software-solutions-workshop-2.onrender.com/api/notes", form);
//       }
//       setForm({ title: "", path: "" });
//       setEditingId(null);
//       fetchNotes();
...
//     try {
//       await axios.delete(`https://ligand-software-solutions-workshop-2.onrender.com/api/notes/${id}`);
//       fetchNotes();
//     } catch (err) {
...
//     try {
//       await axios.patch(`https://ligand-software-solutions-workshop-2.onrender.com/api/notes/${id}/toggle`);
//       fetchNotes();
//     } catch (err) {
...
const AdminNotesControl = () => {
  ...
  const fetchNotes = async () => {
    try {
      setLoading(true);
      const res = await axios.get("https://ligand-software-solutions-workshop-2.onrender.com/api/notes/admin"); 
      setNotes(res.data);
    } catch (err) {
      console.error("Error fetching notes", err);
    } finally {
