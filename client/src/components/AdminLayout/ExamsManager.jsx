...
export default function ManageExamAndNoteVisibility() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Fetch exams
        const examsRes = await axios.get("https://ligand-software-solutions-workshop-2.onrender.com/api/exams/examsforadmin");
        setExams(examsRes.data);

        // Fetch notes
        const notesRes = await axios.get("https://ligand-software-solutions-workshop-2.onrender.com/api/notes/admin");
        setNotes(notesRes.data);

        // Fetch colleges added by admin
        const collegesRes = await axios.get("https://ligand-software-solutions-workshop-2.onrender.com/api/options/collegeName");
  ...
  const toggleExamCollege = async (examId, collegeName) => {
    try {
      await axios.put(`https://ligand-software-solutions-workshop-2.onrender.com/api/exams/exams/${examId}/college`, { collegeName });
      const updated = await axios.get("https://ligand-software-solutions-workshop-2.onrender.com/api/exams/examsforadmin");
  ...
  const toggleNoteCollege = async (noteId, collegeName) => {
    try {
      await axios.put(`https://ligand-software-solutions-workshop-2.onrender.com/api/notes/${noteId}/college`, { collegeName });
      const updated = await axios.get("https://ligand-software-solutions-workshop-2.onrender.com/api/notes/admin");
